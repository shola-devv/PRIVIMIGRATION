...
export default function  Login(){
 ...
 return(
        ...
        <div className='bg-slate-200 rounded-xl p-20 sm:p-6 md:p-10 xl:20px'>
          <h1 className='mx-auto my-auto  sm:text-lg md:text-xl lg:text-2xl p-8 xl:text-3xl 2xl:text-3xl  font-bold'>     PRIVIMIGRATION</h1>
          <h2 className='sm:text-lg md:text-xl lg:text-2xl xl:text-3xl 2xl:text-3xl font-semibold'>SignUp</h2>
         <form>
